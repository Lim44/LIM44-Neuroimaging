function [secs, keyCode, deltaSecs,type] = KbWait2(deviceNumber, forWhat, untilTime)
% [secs, keyCode, deltaSecs,type] = KbWait([deviceNumber][, forWhat=0][, untilTime=inf])
%
