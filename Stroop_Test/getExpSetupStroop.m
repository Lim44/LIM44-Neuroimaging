function setup = getExpSetupStroop(flag)
% This function organizes the experimental setup information, as well as
% participant information for the Stroop experiment
% Input:
...
% Call guiStroop function to ask input from researcher
[setup.subj.id,setup.stage] = guiStroop;
