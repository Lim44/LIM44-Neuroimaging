function ptb = initializePtbSettingsStroop(setup)
% This function initializes all Psychtoolbox parameters prior to the
% beginnig of the Stroop experiment
% Input:
...
ptb.device.red = KbName('1!');
ptb.device.blue= KbName('2@');
ptb.device.green = KbName('3#');
